...
import com.example.jihad.weatherupdate.DatabaseHelper.DBHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (listData.size() < 1) {
            ...
            CustomAdapter adapter = new CustomAdapter(MainActivity.this, listData);
    ...
    public class GetDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            parseData(data);
            CustomAdapter cAdapter = new CustomAdapter(MainActivity.this, listData);
